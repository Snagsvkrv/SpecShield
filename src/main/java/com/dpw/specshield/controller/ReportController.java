...
public class ReportController {
    ...
    @PostMapping("/execute")
    public ResponseEntity<?> executeTestSuite(@RequestBody String rawJson,
                                              @RequestHeader(required = true) String tenantId) throws Exception {
        ...
        try {
            ...
            String autoGeneratedId = testSuiteService.execute(testSuite, tenantId);
            return ResponseEntity.status(HttpStatus.ACCEPTED)
                    .body(Map.of(
                            "message", "Test execution request submitted successfully",
                            "executionId", autoGeneratedId,
